...
# `id` siga el formato `s/<service-id>-<target>` y lo valida en tiempo de
# parseo — antes de cualquier sustitución de variables. Por eso el ID se
# hardcodea directamente en cada directiva RUN.
# ─────────────────────────────────────────────────────────────────────────────
