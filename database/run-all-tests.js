...
const TESTS = [
  ...
  { file: 'test-newdb-fiscal-efos.js', label: 'FISCAL.0/1 motor listas SAT (69B+69) + validación RFC (schema+RLS forzado+cruce expense_documents×sat_list_rfcs+idempotencia UPSERT+triage preservado+formato_invalido)', needsApi: false },
