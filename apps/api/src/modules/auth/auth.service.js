...
var ability_factory_1 = require("../../shared/ability/ability.factory");
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(knex, jwtService) {
            this.knex = knex;
            this.jwtService = jwtService;
        }
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var username, password, user, isPasswordValid, rolePermissions, permissions, ability, payload;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            username = loginDto.username, password = loginDto.password;
                            return [4 /*yield*/, this.knex('users as u')
                        ...
                        case 3:
                            ...
                            ability = (0, ability_factory_1.buildAbility)(permissions);
                            payload = {
                                sub: user.id,
                        ...
                        case 4: return [2 /*return*/, (_a.access_token = _b.sent(),
                                _a.user = {
                                    id: user.id,
                                    username: user.username,
                                    nombre: user.nombre,
