...
var AuthController = function () {
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.Post)('login'), (0, swagger_1.ApiOperation)({ summary: 'Inicia sesión con usuario y contraseña' })];
        _getProfile_decorators = [(0, common_1.UseGuards)(require_auth_guard_1.RequireAuthGuard), (0, common_1.Get)('profile'), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Obtiene el perfil del usuario autenticado a partir del JWT' })];
