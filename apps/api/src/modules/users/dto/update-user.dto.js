...
var UpdateUserDto = function () {
    ...
    return _a = /** @class */ (function () {
            function UpdateUserDto() {
                ...
                this.activo = (__runInitializers(this, _role_name_extraInitializers), __runInitializers(this, _activo_initializers, void 0));
                this.supervisor_id = (__runInitializers(this, _activo_extraInitializers), __runInitializers(this, _supervisor_id_initializers, void 0));
        ...
        (function () {
            ...
            _password_decorators = [(0, swagger_1.ApiProperty)({ description: 'Nueva contraseña', required: false })];
            _nombre_decorators = [(0, swagger_1.ApiProperty)({ description: 'Nombre completo', required: false })];
            _zona_decorators = [(0, swagger_1.ApiProperty)({ description: 'Zona asignada (ej. Norte)', required: false })];
            _zona_id_decorators = [(0, swagger_1.ApiProperty)({ description: 'ID de zona asignada (UUID)', required: false })];
            _role_name_decorators = [(0, swagger_1.ApiProperty)({ description: 'Rol del sistema', required: false })];
            _activo_decorators = [(0, swagger_1.ApiProperty)({ description: 'Estado activo o inactivo', required: false })];
            _supervisor_id_decorators = [(0, swagger_1.ApiProperty)({ description: 'ID del supervisor', required: false })];
