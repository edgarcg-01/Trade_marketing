...
export class CapturesController {
  ...
  @ApiOperation({ summary: 'Crear nueva captura (Requiere rol ejecutivo o superadmin)' })
  create(
  ...
  @ApiOperation({ summary: 'Consultar capturas (Requiere rol superadmin o reportes)' })
  ...
  @UseGuards(RolesGuard)
  @Roles('superadmin')
  @ApiOperation({ summary: 'Eliminar una captura por ID (Requiere rol superadmin)' })
