...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, uploadsPath, apiPrefix, config, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    swagger_1.SwaggerModule.setup("".concat(apiPrefix, "/docs"), app, document);
                    port = process.env.API_PORT || process.env.PORT || 3334;
                    return [4 /*yield*/, app.listen(port)];
                case 2:
                    _a.sent();
                    console.log("Application running on port ".concat(port));
                    return [2 /*return*/];
            }
        });
    });
