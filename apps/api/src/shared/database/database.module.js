...
var knexfile_1 = require("../../../../../database/knexfile");
            ...
            providers: [
                {
                    ...
                    useFactory: function () {
                        ...
                        console.log("[DatabaseModule] Environment: ".concat(environment));
                        var config = knexfile_1.connectionConfig[environment];
                        if (!config) {
                            throw new Error("Missing database configuration for environment: ".concat(environment));
                        }
