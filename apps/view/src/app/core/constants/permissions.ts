export enum Permission {
  ...
  ROLES_VER = 'ROLES_VER',
  // COMMERCIAL_ANALYTICS_VER = paraguas del Command Center. Cada reporte tiene
  // su propio permiso para poder acotar un rol a un solo reporte.
  ...
  COMMERCIAL_ERP_PROMOS_VER = 'COMMERCIAL_ERP_PROMOS_VER',
  COMMERCIAL_VENDOR_SALES_VER = 'COMMERCIAL_VENDOR_SALES_VER',
  ...
  // ── Fiscal (motor de listas SAT: EFOS 69-B, Art. 69 + validación RFC) ──
  FISCAL_LISTAS_VER = 'FISCAL_LISTAS_VER',
  FISCAL_LISTAS_GESTIONAR = 'FISCAL_LISTAS_GESTIONAR',
  // ── Fiscal (CFDI: almacén, descarga, conciliación, DIOT, contabilidad electrónica) ──
