    ...
    projects: [
      ...
      },
      {
        ...
        modules: [
          ...
          { id: 'inventory', label: 'Inventario', route: '/comercial/inventory', view: [Permission.COMMERCIAL_INVENTORY_VER], manage: [Permission.COMMERCIAL_INVENTORY_AJUSTAR] },
          { id: 'warehouses', label: 'Almacenes', route: '/comercial/warehouses', view: [Permission.COMMERCIAL_WAREHOUSES_VER], manage: [Permission.COMMERCIAL_WAREHOUSES_GESTIONAR] },
          { id: 'physical-inventory', label: 'Inventario físico', route: '/comercial/inventory/sessions', view: [Permission.COMMERCIAL_INVENTORY_SUPERVISAR], manage: [Permission.COMMERCIAL_INVENTORY_CONTAR, Permission.COMMERCIAL_INVENTORY_RECONCILIAR, Permission.COMMERCIAL_INVENTORY_ASIGNAR] },
