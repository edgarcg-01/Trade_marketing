...
export const PERMISSION_META: Record<string, PermissionMetaEntry> = {
  ...
  [Permission.STORE_ANALYTICS_VER]: { label: 'Análisis semanal', description: 'Ver el análisis de venta por semana (semana vs anterior, tendencia, por sucursal y producto) del Proyecto Tienda.', category: 'Tienda' },
