...
@Component({
  ...
  template: `
    <div class="portal-shell">
      ...
      <div class="portal-column">
        ...
        <!-- FAB AI Assistant (mobile only, shortcut al chat) -->
        <a
  ...
  styles: [
    `
      ...
      .portal-nav-icon-wrap i { font-size: 1rem; }
      ...
      .portal-tab-icon-wrap i { font-size: 1.125rem; }
      .portal-tab-label {
        line-height: 1;
      ...
      /* ── FAB AI Assistant (mobile, sobre el tab bar) ─────────── */
      .portal-fab-ai {
        display: none;
        position: fixed;
      ...
      .portal-fab-ai:active { transform: scale(0.9); }
      .portal-fab-ai.hidden { display: none !important; }
      ...
      .ps-segment-btn i { font-size: 1rem; }
      ...
      .ps-notif-icon i { font-size: 0.95rem; }
      .ps-notif-text {
        display: flex;
        flex-direction: column;
        gap: 2px;
...
export class PortalShellComponent {
  ...
  readonly navItems: NavItem[] = [
    ...
    { path: 'recommendations', label: 'IA', icon: 'pi pi-bolt' },
