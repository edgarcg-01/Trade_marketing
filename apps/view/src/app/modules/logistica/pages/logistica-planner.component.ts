...
import { LogisticaService, RoutePlan } from '../logistica.service';

@Component({
  selector: 'app-logistica-planner',
  standalone: true,
  imports: [CommonModule, FormsModule, ButtonModule, SelectModule, ToastModule, MapComponent],
      ...
      <div class="sheet cols-12">
        <article class="cell cell-span-12 is-flush pl-toolbar">
          <p-select [options]="shipmentOptions()" [(ngModel)]="selectedId" optionLabel="label" optionValue="value"
                    [filter]="true" placeholder="Seleccionar embarque" styleClass="pl-select"
