...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'admin/users', loadComponent: () => import('./modules/dashboard/admin-users/admin-users.component').then(m => m.AdminUsersComponent), canActivate: [permissionGuard(Permission.USUARIOS_GESTIONAR)] },
      { path: 'admin/catalogs/:type', loadComponent: () => import('./modules/dashboard/admin-catalogs/admin-catalogs.component').then(m => m.AdminCatalogsComponent), canActivate: [permissionGuard(Permission.CATALOGO_GESTIONAR)] },
      { path: 'admin/roles/:role_name/permissions', loadComponent: () => import('./modules/dashboard/admin-roles/admin-roles-permissions.component').then(m => m.AdminRolesPermissionsComponent), canActivate: [permissionGuard(Permission.ROLES_CONFIGURAR)] },
      { path: 'admin/planograma', loadComponent: () => import('./modules/dashboard/admin-planograma/admin-planograma.component').then(m => m.AdminPlanogramaComponent), canActivate: [permissionGuard(Permission.PLANOGRAMAS_GESTIONAR)] },
      { path: 'daily-assignments', loadComponent: () => import('./modules/dashboard/daily-assignments/daily-assignments.component').then(m => m.DailyAssignmentsComponent), canActivate: [permissionGuard(Permission.USUARIOS_ASIGNAR_RUTA)] },
    ]
  },
  {
    path: '',
