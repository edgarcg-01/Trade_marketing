...
export class CapturesComponent implements OnInit, OnDestroy {
  ...
  /** Marcas expandidas en el paso 5 del wizard */
  ...
  onSaveCapturaTotal() {
    console.log('[onSaveCapturaTotal] impactoVentaAdicional:', this.impactoVentaAdicional);
    console.log('[onSaveCapturaTotal] impactoRangoCompra:', this.impactoRangoCompra);
  ...
  toggleBrandExpansion(marca: string) {
    this.expandedBrands = {
      ...this.expandedBrands,
      [marca]: !this.expandedBrands[marca]
    };
  }
