...
- **Tolerancia de varianza** configurable (±%/±$/clase ABC) → count-back obligatorio solo de lo que excede. (El endpoint IRA ya acepta `tolerance_pct`; falta el flujo de count-back forzado durante el conteo.)
