...
| `kdpv_folio_caja` | 661 | 49 | 🟢 | Cortes de caja POS por cajero y turno | `c1`=suc · `c2`=caja · `c3`/`c4`=tipo/seq · `c5`/`c10`=fecha_apertura/cierre · `c6`/`c11`=hora_apertura/cierre · `c7`=cajero_apertura · `c12`=cajero_cierre · `c15`=total_efectivo · `c16`=tarjeta · `c17`=transferencia · `c49`=total_venta |
