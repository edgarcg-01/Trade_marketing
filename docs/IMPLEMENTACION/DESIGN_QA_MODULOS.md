...
| Pantalla | Archivo | Estado | D1 | D2 | D3 | D4 | D5 | D6 | D7 | D8 | Hallazgos clave |
|---|---|---|---|---|---|---|---|---|---|---|---|
| Clientes | `comercial/pages/comercial-customers.component.ts` | ⬜ | | | | | | | | | Master-detail candidato |
...
| Pedidos | `comercial/pages/comercial-orders.component.ts` | 🔨 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | Bug pill `pending_approval`→ámbar · Geist Mono · keyboard-nav filas + focus `--action`. Falta verif. visual. |
